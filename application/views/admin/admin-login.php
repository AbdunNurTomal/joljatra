...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Joljatra</b></a>
  </div>
  <?php if(isset($login_error)): ?>
   <div class="col-sm-12" style="margin-top:15px">
        <div class="alert alert-danger">
         <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Login ERROR</strong> User name OR Password Does not match.
        </div>
    </div>
    <?php endif; ?>
  <!-- /.login-logo -->
    ...
    <p class="login-box-msg">LOG IN</p>
     ...
     <form action="<?php echo site_url('login/try_login'); ?>" class="login_form" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" id="inputEmail3" placeholder="User Name" name="user_name" required>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" id="password_input" placeholder="Password" name="password" required>
