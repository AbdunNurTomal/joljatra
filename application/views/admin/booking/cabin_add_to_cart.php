...
<div class="row">
	...
	<?php }else{ ?>
		<p class="text-center lonch_info_p"> মূল্য <?php echo $total_price; ?> <?php echo $this->config->item('currency_symbol') ?></p>
	<?php } ?>
	
	<?php if($this->input->get('f_id')): $single_floor = $this->lonch_model->get_floor($this->input->get('f_id'))?>
