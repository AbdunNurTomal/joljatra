...
<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <section class="content-header">
      <h1> <i class="fa fa-edit"></i> Edit <?php echo $type; ?></h1>
      <ol class="breadcrumb">
     ...
     <!--this is error or success message display message-->
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-edit"></i> page </h3>
            ...
            <div class="col-sm-8">
                <div class="item form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:15px">
                    <input id="name" class="form-control col-md-12 col-xs-12" name="post_title" placeholder="Title in bangla"  type="text" value="<?php echo $post->post_title; ?>" style="color: #666666;font-weight: bold;font-size: 18px;" required>
                  </div>
                </div>
				<div class="item form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:15px">
                    <input id="name" class="form-control col-md-12 col-xs-12" name="post_title_eng" placeholder="Title in english"  type="text" value="<?php echo $post->post_title_eng; ?>" style="color: #666666;font-weight: bold;font-size: 18px;" required>
                  </div>
                </div>
                <div class="item form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:15px">
                   <textarea name="post_content"  id="post_content" class="form-control col-md-7 col-xs-12" name="description" placeholder="Content in bangla" value=""><?php echo $post->post_content; ?></textarea>
                  </div>
                </div>
				<div class="item form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:15px">
                   <textarea name="post_content_eng"  id="post_content_eng" class="form-control col-md-7 col-xs-12" name="description" placeholder="Content in english" value=""><?php echo $post->post_content_eng; ?></textarea>
                  </div>
                </div>
                <div class="item form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:15px">
                   <textarea name="post_excerpt"  id="name" class="form-control col-md-12 col-xs-12" name="post_excerpt" placeholder="Excerpt in bangla" value=""><?php echo  $post->post_excerpt; ?></textarea>
                  </div>
                </div>
				 <div class="item form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:15px">
                   <textarea name="post_excerpt_eng"  id="name" class="form-control col-md-12 col-xs-12" name="post_excerpt_eng" placeholder="Excerpt in english" value=""><?php echo  $post->post_excerpt_eng; ?></textarea>
                  </div>
                </div>
                <br>
