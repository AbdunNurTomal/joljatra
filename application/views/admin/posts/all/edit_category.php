      ...
      <div class="right_col" role="main">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm12 col-xs-12">
              ...
              <div class="x_panel">
                <div class="x_content">
                   <?php echo form_open('admin/posts/edit_category/'.$type.'/'.$id, 'class="form-horizontal form-label-left"'); ?>
                   <?php foreach($category as $cat_value){ ?>
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name<span class="required">*</span>
                      </label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="Categorty Name" required="required" type="text" value="<?php echo $cat_value->category_name; ?>" required>
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="slug" placeholder="Categorty Slug" required="required" type="text" value="<?php echo $cat_value->category_slug; ?>" required>
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                       <textarea name="keyword"  id="name" class="form-control col-md-7 col-xs-12" name="keyword" placeholder="Categorty keyword" value=""><?php echo $cat_value->category_keyword; ?></textarea>
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                       <textarea name="description"  id="name" class="form-control col-md-7 col-xs-12" name="description" placeholder="Categorty Description" value=""><?php echo $cat_value->category_description; ?></textarea>
                      </div>
                    </div>
                ...
                <div class="x_content">
                    ...
                    <tbody>
                     <?php echo form_open('admin/posts/delete_all_category/'.$type); ?>
                      ...
                      <a href="<?php echo site_url('admin/posts/category/post'); ?>" class="btn btn-primary btn-xs">Add new category</a>
                      </div>
                      <?php echo form_close(); ?>
                    </tbody>
                  </table>
