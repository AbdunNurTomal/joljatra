      ...
      <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Messages <span class="badge bg-red"></span> </h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <p><b>Name:</b> <?php echo $message->name; ?></p>
              <p><b>Email: </b><?php echo $message->email; ?></p>
              <p style="border-bottom: 1px solid #DDD;"><b>Phone: </b><?php echo $message->phone; ?></p>
