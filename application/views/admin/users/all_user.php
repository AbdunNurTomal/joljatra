...
<?php $this->load->view('admin/inc/sidebar'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Users List <a href="<?php echo site_url('admin/users/add_new'); ?>" class="btn btn-success">Add new user</a>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body">
              <div class="col-sm-12">
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                        <a href="<?php echo site_url('admin/users/edit_user/'.$user->id); ?>" class="btn btn-success"><i class="fa fa-pencil-square-o"></i></a>
                        <a href="<?php echo site_url('admin/users/delete/'.$user->id); ?>" class="btn btn-danger" onclick="return confirm('Are you shure...? You really want delete this user');"><i class="fa fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
