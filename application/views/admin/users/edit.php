          ...
          <div class="box">
               ...
               <div class="customer_left_bar">
				   ...
				   <div class="col-sm-12">
					   <div class="update_profile_image">
							<?php echo form_open_multipart('admin/users/edit_photo/'.$user_id); ?>
			...
			<div class="col-sm-8">
			    <assaid class="customer_profile_info">
					<?php echo form_open('admin/users/edit_user/'.$user_id); ?>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input id="type" class="form-control desabled"  placeholder="User Name" name="type" type="text" value="<?php echo $user_data->type; ?>" disabled >
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="submit" name="save_user" value="Save Changes" class="btn btn-danger btn-reservation" />
								<a href="<?php echo site_url('admin/users/change_password/'.$user_data->id); ?>" class="btn btn-success "> <i class="fa fa-edit"></i> Change Password</a>
							</div>
						</div>
