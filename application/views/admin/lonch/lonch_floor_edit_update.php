                ...
                <div class="modal fade" id="edit_floor_model" tabindex="-1" role="dialog" aria-labelledby="edit_model_label">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
						<?php echo form_open('#', array('id'=>'edit_floor_form', 'class'=>'save_edited_floor')); ?>
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					...
					<div class="modal-body" style="overflow: hidden;">       
						<div class="col-sm-4">
                              <div class="form-group row">
                                   <label for="lonch_schedule" class="col-sm-12 col-form-label">Lonch Schedule</label>
                                    <div class="col-sm-12">
										<select class="form-control edit_lonch_schedule" name="edit_lonch_schedule" id="edit_lonch_schedule" required>
										   <option value="">Select</option>
											<?php 
												if($lonch_schedules){
													foreach($lonch_schedules as $schedules){
                          ...
                          <div class="col-sm-4">
                              <div class="form-group row">
                                    <label for="floor_name" class="col-sm-12 col-form-label">Floor name</label>
                                    <div class="col-sm-12">
                                        <input class="form-control floor_name" id="floor_name" placeholder="Floor name" name="floor_name" type="text" required>
                                    </div>
                                </div>
                          </div>
						  <!--
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" name="edit_floor" id="edit_floor_button" class="btn btn-primary edit_floor_button"> Edit Floor</button>
                      </div>
                    <?php echo form_close(); ?>
                    </div>
                  </div>
