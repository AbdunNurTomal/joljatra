...
class Staff_model extends MY_Model{
    ...
    // this function for get all staff my pagination
     public function get_all_staff( $per_page=null, $page=null){
        $result=0;
        if($per_page!=null){
    ...
    public function get_staff($id=null){
         $result = $this->db->get_where('staff', array('id'=>$id));
        return $result->row(0);
    }
            ...
            if($all_staff){
                foreach($all_staff as $staff){
                    ...
                    <tr>
                        ...
                        <td>'.$staff->salary.'.00 '.$this->config->item('currency_symbol').'</td>
                        <td>'.$this->advanced($staff->id, $i, $year).'.00 '.$this->config->item('currency_symbol').'</td>
